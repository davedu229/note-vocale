...
const PrivacyPage = () => {
    ...
    return (
        <div className="pb-20">
            ...
            <h1 className="text-2xl font-bold text-text-primary mb-6">Politique de confidentialité</h1>
            ...
            <div className="prose prose-invert prose-sm max-w-none">
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">1. Données collectées</h2>
                    <p className="text-text-secondary text-sm leading-relaxed mb-2">
                        Nous collectons les données suivantes :
                    </p>
                    <ul className="list-disc list-inside text-text-secondary text-sm space-y-1">
                        <li><strong className="text-text-primary">Enregistrements audio :</strong> Stockés localement sur votre appareil</li>
                        <li><strong className="text-text-primary">Transcriptions :</strong> Générées et stockées localement</li>
                        <li><strong className="text-text-primary">Données d'usage :</strong> Statistiques anonymisées pour améliorer le service</li>
                    </ul>
                </section>

                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">2. Utilisation des données</h2>
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">3. Stockage et sécurité</h2>
                    <p className="text-text-secondary text-sm leading-relaxed">
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">4. Services tiers</h2>
                    <p className="text-text-secondary text-sm leading-relaxed">
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">5. Vos droits</h2>
                    <p className="text-text-secondary text-sm leading-relaxed mb-2">
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">6. Suppression des données</h2>
                    <p className="text-text-secondary text-sm leading-relaxed">
                ...
                <section className="mb-6">
                    <h2 className="text-lg font-semibold text-text-primary mb-3">7. Contact DPO</h2>
                    <p className="text-text-secondary text-sm leading-relaxed">
